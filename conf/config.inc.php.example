...
# Logo
$logo = "/images/example-square.png";

# Debug mode
$debug = true;

# Encryption, decryption keyphrase
$keyphrase = "changemetosomethingsecret";

# Where to log password resets - Make sure apache has write permission
# By default, they are logged in Apache log
#$reset_request_log = "/var/log/httpd/self-service-password-resets.log";
...
$messages['changehelpextramessage'] = "Contact admin@example.com if you need additional help.";
